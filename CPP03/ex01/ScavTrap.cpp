...
/*   Updated: 2020/12/23 21:03:37 by esoulard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(void): _maxHitPoints(100), _maxEnergyPoints(50), 
...
ScavTrap::ScavTrap(std::string const name): _name(name), _maxHitPoints(100), 
						_maxEnergyPoints(50), _meleeAttackDamage(20),
...
ScavTrap::ScavTrap(ScavTrap const &src): _maxHitPoints(100), _maxEnergyPoints(50), 
						_meleeAttackDamage(20), _rangedAttackDamage(15), 
						_armorDamageReduction(3) {
...
int const 			ScavTrap::getHP(void) const {

	return this->_hitPoints;
};

int const 			ScavTrap::getEP(void) const {
